...
- **Seller (SME):** Creates invoice → receives 75–88% upfront (based on credit score tier)
- **Buyer:** Pays 100% of invoice at due date (7-day grace period)
- **Investor:** Deposits USDC into pool → earns 12–25% spread
...
| Fair      | 41–70   | 80%     | 20%         |
| Good      | 71–85   | 84%     | 16%         |
| Excellent | 86–100  | 88%     | 12%         |

### Deployed Contracts v6a (Arc Testnet)
- **FloatPool:** `0x866Af692C71D9e1d191be551981c546870413484` (ERC20 "Float LP" / fLP)
- **FloatCore:** `0xadAf850c7EA6Bb6c14bD91A41B6B2168A91142bD`
- **v6a (economic recalibration):** advance 80/85/88/90%, stake 5/4/3/2%, light collateral 25/18/12/8%;
  ...
  Carries v5 strict collateral + per-buyer cap. 25/25 Hardhat tests pass. See `docs/v6-plan.md`.
